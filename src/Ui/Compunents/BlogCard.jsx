...
const BlogCard = ({ heading,image, createdAt, readTime, category, blogDescription, thumbnail }) => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-md overflow-hidden">
      ...
      <div className="p-4">
        ...
        <Link  
        to={`/ArticleDetail/${encodeURIComponent(heading)}/${encodeURIComponent(createdAt)}/${encodeURIComponent(readTime)}/${encodeURIComponent(category)}/${encodeURIComponent(blogDescription)}/${encodeURIComponent(thumbnail)}`}
